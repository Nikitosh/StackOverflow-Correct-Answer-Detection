...
class Word2VecModelTrainer:
    ...
    def train(self, data_reader, ids):
        ...
        word2vec_model.build_vocab(data_reader.get_texts_as_lists(ids), update=True)
        word2vec_model.train(data_reader.get_texts_as_lists(ids), epochs=word2vec_model.iter,
